...
echo -e ${BLUE}"and future implementations. Zero information is transmitted off the VPS or"${CLEAR}
echo -e ${BLUE}"collected for any advertising or information harvesting from this script."${CLEAR}
echo
